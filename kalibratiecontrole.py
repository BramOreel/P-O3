...
def xyz(middelpunten):
    ...
    for i in middelpunten:
        x.append(middelpunten[0])
        y.append(middelpunten[1])
        z.append(middelpunten[2])
    return x, y, z
...
predictparaboolbaanMiddelpunten(middelpuntenM,n)
predictparaboolbaanUiteindePunten(middelpuntenU,n)